...
final class SchemaSyncCommandTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->tmpDir = sprintf('%s/cycle_schema_sync_%s', sys_get_temp_dir(), bin2hex(random_bytes(6)));
    ...
    public function testExecuteWithEnabledCacheRefreshesCompiledSchema(): void
    {
        ...
        $this->assertStringContainsString('Schema synchronized and compiled cache refreshed.', $tester->getDisplay());
    }
    ...
    public function testExecuteWithDisabledCacheSkipsCompiledSchemaSave(): void
    {
        ...
        $this->assertStringContainsString(
            'Schema synchronized. Compiled cache update skipped (cache disabled).',
            $tester->getDisplay(),
        );
    }
    ...
    public function testExecuteReturnsFailureOnCompilerError(): void
    {
        ...
        $this->assertFalse(file_exists($this->schemaPath));
        $this->assertStringContainsString('Failed to synchronize schema: sync failed', $tester->getDisplay());
    }
}
